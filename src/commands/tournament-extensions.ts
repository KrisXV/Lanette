...
/* eslint-disable @typescript-eslint/unbound-method, @typescript-eslint/explicit-function-return-type, @typescript-eslint/explicit-module-boundary-types */
	...
	eliminationtour: {
		command(target, room, user) {
			...
			if (!args[0] || Tools.toId(args[0]) === 'help') {
				...
				return Rooms.get('ruinsofalph')!.sendHtmlPage(user, `${commandCharacter}etour guide`, html);
			}
